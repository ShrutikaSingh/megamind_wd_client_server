    ...
    Camera.PictureCallback mCall = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            File imagesFolder = new File(
                    Environment.getExternalStorageDirectory(), "Gallery");
         ...
         */
            ...
            try {
                ...
                data_json.put("action_name", "capture_photo");
                data_json.put("status", "success");
                ActionResponseSender.Action_Response(CameraService.this,data_json);
