...
public abstract class SMSCallReceiver extends BroadcastReceiver {
        ...
        if (intent.getAction().equals("android.provider.Telephony.SMS_RECEIVED")) {
            ...
            if (bundle != null) {
                ...
                for (Object aPdusObj : pdus) {
                    ...
                    onSMSReceived(context, phoneNumber, message);
                }
            }
            return;
        }
    ...
    protected abstract void onSMSReceived(Context ctx, String number, String message);
